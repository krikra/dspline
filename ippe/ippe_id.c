...
void initial_grid(ippe *ip, int *nd_init)
{
	int j;
...
void initial_user_2d(ippe *ip, char *path)
{
	int iter;
	FILE *fp;
	int num = ip->dd_init;
...
void initial_user_3d(ippe *ip, char *path)
{
	int iter;
	FILE *fp;
	int num = ip->dd_init;
...
void scan_2d(FILE *fp, double *xx, int n)
{
	int iter;
...
void scan_3d(FILE *fp, double *xx, int n)
{
	int iter;
...
void scan_4d(FILE *fp, double *xx, int n)
{
	int iter;
...
void initial_user(ippe *ip, char *path)
{
	int i;
	int iter;
	int tmp;
